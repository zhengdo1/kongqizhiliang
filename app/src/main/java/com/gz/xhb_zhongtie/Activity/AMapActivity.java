...
import com.gz.xhb_zhongtie.MVP.Presenter.MapPresenter;
...
public class AMapActivity extends XHBBaseActivity implements MapInfoView, GeocodeSearch.OnGeocodeSearchListener {
    ...
    Map<String, com.gz.xhb_zhongtie.MVP.Model.Entity.Map> dataMap = new HashMap<>();
...
//            geocoderSearch.getFromLocationNameAsyn(query);
            ...
            AMap.OnMarkerClickListener markerClickListener = new AMap.OnMarkerClickListener() {
                ...
                public boolean onMarkerClick(Marker marker) {
                    ...
                    intent.putExtra("data", (com.gz.xhb_zhongtie.MVP.Model.Entity.Map) dataMap.get(marker.getTitle()));
    ...
    private void addMarkersToMap(List<com.gz.xhb_zhongtie.MVP.Model.Entity.Map> psBeanList) {
        MarkerOptions[] option = new MarkerOptions[psBeanList.size()];
        for (int i = 0; i < psBeanList.size(); i++) {
            LatLng latLng;
            try {
                com.gz.xhb_zhongtie.MVP.Model.Entity.Map psBean = psBeanList.get(i);
...
//            hashMap.put(psBeanList.get(i).getId(), psBeanList.get(i));
    ...
    @Override
    public void showPsDot(List<com.gz.xhb_zhongtie.MVP.Model.Entity.Map> list) {
